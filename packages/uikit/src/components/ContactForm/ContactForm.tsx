  ...
  return (
    <form
      ...
      <div className="w-full space-y-6">
        <Input id="name" name="name" label="Imię*" required value={formData.name} onChange={handleInputChange} />
        <Input id="lastName" name="lastName" label="Nazwisko*" required value={formData.lastName} onChange={handleInputChange} />
        <EmailInput id="email" name="email" required value={formData.email} onChange={handleInputChange} />
        <PhoneInput
          id="phone"
          name="phone"
          label="Telefon*"
        ...
        />
        <Textarea id="message" name="message" label="Wiadomość*" required value={formData.message} onChange={handleInputChange} />
        <Checkbox
